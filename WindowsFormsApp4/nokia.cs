...
{
    public partial class nokia : Form
    {
        public nokia()
        {
            InitializeComponent();
        ...
        private void nokia_Load(object sender, EventArgs e)
        {

        }
        private void LoadNokiaMobiles()
        {
            ...
            string query = "SELECT MobileID, Name, Model, Stock, Price, Concession, Vendor, VendorNumber, EntryTime FROM ADD_MOBILE WHERE Name = 'Nokia'";
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                ...
                using (SqlDataReader reader = cmd.ExecuteReader())
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        CreateTextBox(vendor, 420, y);

                        CreateLabel("Vendor No:", 620, y); // New
                        CreateTextBox(vendorNumber, 740, y); // New
