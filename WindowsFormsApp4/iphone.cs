...
namespace WindowsFormsApp4
{
    public partial class iphone : Form
    {
        ...
        private void LoadIphoneMobiles()
        {
            ...
            string query = "SELECT MobileID, Name, Model, Stock, Price, Concession, Vendor, VendorNumber, EntryTime FROM ADD_MOBILE WHERE Name = 'iPhone'";
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                ...
                using (SqlDataReader reader = cmd.ExecuteReader())
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        CreateLabel("Vendor No:", 620, y); // New field
                        CreateTextBox(vendorNumber, 720, y); // New field
                        ...
                        y += 40; // Add spacing between records
                    }
                }
